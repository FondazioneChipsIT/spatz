...
void TEST_CASE1(void) {
  ...
  //              0.2908894437497427
  VLOAD_64(v4, 0xbfe3d86354c44060, 0x3fe8a5747d1fa1c6, 0x3fd512a81cf2063c,
  ...
  VLOAD_64(v6, 0x3fe5502df6e661fe, 0xbfeebb482d68699c, 0xbfbdebe0a2632640,
  ...
  //              -3.2974384260161655
  VCMP_U64(3, v2, 0xbfedcbc7be65070a, 0xbfe9a9dfe464e0ca, 0xc006896ac2e79279,
...
void TEST_CASE2(void) {
  ...
  VCMP_U32(5, v2, 0x0, 0xbc68f04d, 0x0, 0xbedaa462, 0x0, 0xbfb12b5e, 0x0,
  ...
  VCMP_U64(6, v2, 0x0, 0xbfe9a9dfe464e0ca, 0x0, 0x4004b5a57f7b305c, 0x0,
...
void TEST_CASE3(void) {
  ...
  asm volatile("vfdiv.vf v2, v4, %[A]" ::[A] "f"(fscalar_16));
  ...
  VLOAD_32(v4, 0x3f3e58e0, 0x3efed8a2, 0x3e83a8b1, 0x3f042ff7, 0x3f3ee5f1,
  ...
  VCMP_U32(8, v2, 0xbfcf0722, 0xbf8a96ef, 0xbf0f3255, 0xbf8fc576, 0xbfcfa090,
  ...
  VLOAD_64(v4, 0xbfeb74d95495be72, 0xbfde8f9f69544024, 0x3fd885803c550ed0,
  ...
  asm volatile("vfdiv.vf v2, v4, %[A]" ::[A] "f"(dscalar_64));
  ...
  VCMP_U64(9, v2, 0xc05d864f99ce434b, 0xc0506e79eef36846, 0x404a5e5dbaeb1cfe,
...
void TEST_CASE4(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v2);
  asm volatile("vfdiv.vf v2, v4, %[A], v0.t" ::[A] "f"(fscalar_16));
  ...
  VCMP_U32(11, v2, 0x0, 0xbf8a96ef, 0x0, 0xbf8fc576, 0x0, 0xbf69327c, 0x0,
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v2);
  asm volatile("vfdiv.vf v2, v4, %[A], v0.t" ::[A] "f"(dscalar_64));
  ...
  VCMP_U64(12, v2, 0x0, 0xc0506e79eef36846, 0x0, 0xc048a880b0658b57, 0x0,
