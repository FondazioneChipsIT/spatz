...
void Conv3_v10 (float *In_Img, float *Out_Img, float  *Kernel, int ROW, int COL, int Stride, int Input_cl, int Input_row, int FILT_W, unsigned int vl){
  ...
  for (int row = 0; row < Input_row; row+=3){
    ...
    if(itr*VLMAX < num_elements){//THIS ONE WORKS
      ...
      if(row == 0){
        ...
        ///////////
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+1)*Input_cl+itr*VLMAX));
        f0 = Kernel[0];
        ...
        asm volatile("vfmacc.vf  v12, %0, v0" ::"f"(f1));
        ///////////
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+2)*Input_cl+itr*VLMAX));
        f0 = Kernel[0];
        ...
        asm volatile("vse32.v v12, (%0)" :: "r"(Out_Img+(row)*COL+itr*(VLMAX-FILT_W+1)));

      // }else if(row == Input_row-FILT_W+1){
      //   asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row)*Input_cl+itr*VLMAX));//0
      //   f1 = Kernel[3];
      ...
      //   asm volatile("vse32.v v8, (%0)" :: "r"(Out_Img+(row-2)*COL+itr*(VLMAX-FILT_W+1)));
      //   ///////////
      ...
      //   asm volatile("vse32.v v4, (%0)" :: "r"(Out_Img+(row-1)*COL+itr*(VLMAX-FILT_W+1)));
      //   ///////////

      // }else if(row == Input_row-FILT_W+2){
      //   asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row)*Input_cl+itr*VLMAX));//0
      //   f2 = Kernel[6];
      //   asm volatile("vfmacc.vf v8 , %0, v0" ::"f"(f2));
      ...
      //   asm volatile("vfmul.vf  v24, v0, %0" ::"f"(f3));
      //   asm volatile("vfmul.vf  v28, v0, %0" ::"f"(f6));
...
void Conv3_v15 (float *In_Img, float *Out_Img, float  *Kernel, int ROW, int COL, int Stride, int Input_cl, int Input_row, int FILT_W, unsigned int vl){
  ...
  while(itr*VLMAX + VLMAX <= num_elements){
    for (row = 0; row+3 < Input_row; row+=3){
      if(row == 0){
        ...
        asm volatile("vse32.v v12, (%0)" :: "r"(Out_Img+(row)*COL+itr*(VLMAX)));
        ...
        asm volatile("vse32.v v8, (%0)" :: "r"(Out_Img+(row-2)*COL+itr*(VLMAX)));
        ///////////
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+1)*Input_cl+itr*VLMAX));
        temp = In_Img[(row+1)*Input_cl + itr*VLMAX +  VLMAX + 0];
        asm volatile("vfslide1down.vf v16, v0, %[A]" ::[A] "f"(temp));
        ...
        asm volatile("vse32.v v4, (%0)" :: "r"(Out_Img+(row-1)*COL+itr*(VLMAX)));
        ///////////
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+2)*Input_cl+itr*VLMAX));
        temp = In_Img[(row+2)*Input_cl + itr*VLMAX +  VLMAX + 0];
        asm volatile("vfslide1down.vf v16, v0, %[A]" ::[A] "f"(temp));
...
void Conv5_v12 (float *In_Img, float *Out_Img, float  *Kernel, int ROW, int COL, int Stride, int Input_cl, int Input_row, int FILT_W, unsigned int vl){
  ...
  while(itr*VLMAX + VLMAX <= num_elements){
    for (row = 0; row+5 < Input_row; row+=5){
      if(row == 0){
        ...
        ///////////
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+3)*Input_cl+itr*VLMAX));
        ...
        ///////////
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+4)*Input_cl+itr*VLMAX));
        ...
        asm volatile("vse32.v v20, (%0)" :: "r"(Out_Img+(row)*COL+itr*(VLMAX)));

      }else{
        /////////// 0
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row)*Input_cl+itr*VLMAX));
        temp = In_Img[(row)*Input_cl + itr*VLMAX +  VLMAX + 0];
        asm volatile("vfslide1down.vf v24, v0, %[A]" ::[A] "f"(temp));
        ...
        asm volatile("vse32.v v16, (%0)" :: "r"(Out_Img+(row-4)*COL+itr*(VLMAX)));
        ...
        asm volatile("vse32.v v12, (%0)" :: "r"(Out_Img+(row-3)*COL+itr*(VLMAX)));        
...
void Conv7_v4 (float *In_Img, float *Out_Img, float  *Kernel, int ROW, int COL, int Stride, int Input_cl, int FILT_W, unsigned int vl){
...
void Conv7_v13 (float *In_Img, float *Out_Img, float  *Kernel, int ROW, int COL, int Stride, int Input_cl, int Input_row, int FILT_W, unsigned int vl){
  ...
  while(itr*VLMAX + VLMAX <= num_elements){
    for (row = 0; row + 7< Input_row; row+=7){
      if(row == 0){
        ...
        // temp = In_Img[(row)*Input_cl + itr*VLMAX +  VLMAX + 1];
        // asm volatile("vfslide1down.vf v0, v16, %[A]" ::[A] "f"(temp));
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row)*Input_cl+itr*VLMAX+1));//0
        f0 = Kernel[1];
        asm volatile("vfmacc.vf  v28, %0, v0" ::"f"(f0));

        // temp = In_Img[(row)*Input_cl + itr*VLMAX +  VLMAX + 2];
        // asm volatile("vfslide1down.vf v16, v0, %[A]" ::[A] "f"(temp));
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row)*Input_cl+itr*VLMAX+2));//0
        f0 = Kernel[2];
        asm volatile("vfmacc.vf  v28, %0, v0" ::"f"(f0));

        // temp = In_Img[(row)*Input_cl + itr*VLMAX +  VLMAX + 3];
        // asm volatile("vfslide1down.vf v0, v16, %[A]" ::[A] "f"(temp));
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row)*Input_cl+itr*VLMAX+3));//0
        f0 = Kernel[3];
        asm volatile("vfmacc.vf  v28, %0, v0" ::"f"(f0));

        // temp = In_Img[(row)*Input_cl + itr*VLMAX +  VLMAX + 4];
        // asm volatile("vfslide1down.vf v16, v0, %[A]" ::[A] "f"(temp));
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row)*Input_cl+itr*VLMAX+4));//0
        f0 = Kernel[4];
        asm volatile("vfmacc.vf  v28, %0, v0" ::"f"(f0));

        // temp = In_Img[(row)*Input_cl + itr*VLMAX +  VLMAX + 5];
        // asm volatile("vfslide1down.vf v0, v16, %[A]" ::[A] "f"(temp));
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row)*Input_cl+itr*VLMAX+5));//0
        f0 = Kernel[5];
        asm volatile("vfmacc.vf  v28, %0, v0" ::"f"(f0));

        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row)*Input_cl+itr*VLMAX+6));//0
        f0 = Kernel[6];
        asm volatile("vfmacc.vf  v28, %0, v0" ::"f"(f0));
        #pragma endregion

        // asm volatile("vse32.v v28, (%0)" :: "r"(tempArr));
        // printf("temp[0] = %f\n",tempArr[0]);
        ...
        // temp = In_Img[(row+1)*Input_cl + itr*VLMAX +  VLMAX + 1];
        // asm volatile("vfslide1down.vf v0, v16, %[A]" ::[A] "f"(temp));
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+1)*Input_cl+itr*VLMAX+1));
        f0 = Kernel[1];
        ...
        // temp = In_Img[(row+1)*Input_cl + itr*VLMAX +  VLMAX + 2];
        // asm volatile("vfslide1down.vf v16, v0, %[A]" ::[A] "f"(temp));
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+1)*Input_cl+itr*VLMAX+2));
        f0 = Kernel[2];
        asm volatile("vfmacc.vf  v24, %0, v0" ::"f"(f0));
        f1 = Kernel[9];
        asm volatile("vfmacc.vf  v28, %0, v0" ::"f"(f1));
        ...
        // asm volatile("vfslide1down.vf v16, v0, %[A]" ::[A] "f"(temp));
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+1)*Input_cl+itr*VLMAX+4));
        f0 = Kernel[4];
        asm volatile("vfmacc.vf  v24, %0, v0" ::"f"(f0));
        f1 = Kernel[11];
        asm volatile("vfmacc.vf  v28, %0, v0" ::"f"(f1));
        ...
        // asm volatile("vfslide1down.vf v0, v16, %[A]" ::[A] "f"(temp));
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+1)*Input_cl+itr*VLMAX+5));
        f0 = Kernel[5];
        asm volatile("vfmacc.vf  v24, %0, v0" ::"f"(f0));
        f1 = Kernel[12];
        asm volatile("vfmacc.vf  v28, %0, v0" ::"f"(f1));

        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+1)*Input_cl+itr*VLMAX+6));
        f0 = Kernel[6];
        asm volatile("vfmacc.vf  v24, %0, v0" ::"f"(f0));
        f1 = Kernel[13];
        asm volatile("vfmacc.vf  v28, %0, v0" ::"f"(f1));
        ...
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+2)*Input_cl+itr*VLMAX+1));  
        f0 = Kernel[1];
        asm volatile("vfmacc.vf  v20, %0, v0" ::"f"(f0));
        f1 = Kernel[8];
        asm volatile("vfmacc.vf  v24, %0, v0" ::"f"(f1));
        ...
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+2)*Input_cl+itr*VLMAX+2));  
        f0 = Kernel[2];
        asm volatile("vfmacc.vf  v20, %0, v0" ::"f"(f0));
        f1 = Kernel[9];
        asm volatile("vfmacc.vf  v24, %0, v0" ::"f"(f1));
        ...
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+2)*Input_cl+itr*VLMAX+3));  
        f0 = Kernel[3];
        asm volatile("vfmacc.vf  v20, %0, v0" ::"f"(f0));
        f1 = Kernel[10];
        asm volatile("vfmacc.vf  v24, %0, v0" ::"f"(f1));
        ...
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+2)*Input_cl+itr*VLMAX+4));  
        f0 = Kernel[4];
        asm volatile("vfmacc.vf  v20, %0, v0" ::"f"(f0));
        f1 = Kernel[11];
        asm volatile("vfmacc.vf  v24, %0, v0" ::"f"(f1));
        ...
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+2)*Input_cl+itr*VLMAX+5));  
        f0 = Kernel[5];
        asm volatile("vfmacc.vf  v20, %0, v0" ::"f"(f0));
        f1 = Kernel[12];
        asm volatile("vfmacc.vf  v24, %0, v0" ::"f"(f1));
        ...
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+3)*Input_cl+itr*VLMAX+1));
        f0 = Kernel[1];
        asm volatile("vfmacc.vf  v16 , %0, v0" ::"f"(f0));
        f1 = Kernel[8];
        asm volatile("vfmacc.vf  v20, %0, v0" ::"f"(f1));
        ...
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+3)*Input_cl+itr*VLMAX+2));
        f0 = Kernel[2];
        asm volatile("vfmacc.vf  v16 , %0, v0" ::"f"(f0));
        f1 = Kernel[9];
        asm volatile("vfmacc.vf  v20, %0, v0" ::"f"(f1));        
        ...
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+3)*Input_cl+itr*VLMAX+3));
        f0 = Kernel[3];
        asm volatile("vfmacc.vf  v16 , %0, v0" ::"f"(f0));
        f1 = Kernel[10];
        asm volatile("vfmacc.vf  v20, %0, v0" ::"f"(f1));
        ...
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+3)*Input_cl+itr*VLMAX+4));
        f0 = Kernel[4];
        asm volatile("vfmacc.vf  v16 , %0, v0" ::"f"(f0));
        f1 = Kernel[11];
        asm volatile("vfmacc.vf  v20, %0, v0" ::"f"(f1));        
        ...
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+3)*Input_cl+itr*VLMAX+5));
        f0 = Kernel[5];
        asm volatile("vfmacc.vf  v16 , %0, v0" ::"f"(f0));
        f1 = Kernel[12];
        asm volatile("vfmacc.vf  v20, %0, v0" ::"f"(f1));
        ...
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+3)*Input_cl+itr*VLMAX+6));
        f0 = Kernel[6];
        asm volatile("vfmacc.vf  v16 , %0, v0" ::"f"(f0));
        f1 = Kernel[13];
        asm volatile("vfmacc.vf  v20, %0, v0" ::"f"(f1));        
        ...
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+4)*Input_cl+itr*VLMAX+1));
        f0 = Kernel[1];
        asm volatile("vfmacc.vf  v12 , %0, v0" ::"f"(f0));
        f1 = Kernel[8];
        asm volatile("vfmacc.vf  v16 , %0, v0" ::"f"(f1));        
        ...
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+4)*Input_cl+itr*VLMAX+2));
        f0 = Kernel[2];
        asm volatile("vfmacc.vf  v12 , %0, v0" ::"f"(f0));
        f1 = Kernel[9];
        asm volatile("vfmacc.vf  v16 , %0, v0" ::"f"(f1));        
        ...
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+4)*Input_cl+itr*VLMAX+3));
        f0 = Kernel[3];
        asm volatile("vfmacc.vf  v12 , %0, v0" ::"f"(f0));
        f1 = Kernel[10];
        asm volatile("vfmacc.vf  v16 , %0, v0" ::"f"(f1));        
        ...
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+4)*Input_cl+itr*VLMAX+4));
        f0 = Kernel[4];
        asm volatile("vfmacc.vf  v12 , %0, v0" ::"f"(f0));
        f1 = Kernel[11];
        asm volatile("vfmacc.vf  v16 , %0, v0" ::"f"(f1));        
        ...
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+4)*Input_cl+itr*VLMAX+5));
        f0 = Kernel[5];
        asm volatile("vfmacc.vf  v12 , %0, v0" ::"f"(f0));
        f1 = Kernel[12];
        asm volatile("vfmacc.vf  v16 , %0, v0" ::"f"(f1));        
        ...
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+4)*Input_cl+itr*VLMAX+6));
        f0 = Kernel[6];
        asm volatile("vfmacc.vf  v12 , %0, v0" ::"f"(f0));
        f1 = Kernel[13];
        asm volatile("vfmacc.vf  v16 , %0, v0" ::"f"(f1));        
        ...
        #pragma region 5
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+5)*Input_cl+itr*VLMAX));
        f0 = Kernel[0];
        asm volatile("vfmul.vf   v8 , v0, %0" ::"f"(f0));
        f1 = Kernel[7];
        asm volatile("vfmacc.vf  v12 , %0, v0" ::"f"(f1));        
        ...
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+5)*Input_cl+itr*VLMAX+1));
        f0 = Kernel[1];
        asm volatile("vfmacc.vf  v8 , %0, v0" ::"f"(f0));
        f1 = Kernel[8];
        asm volatile("vfmacc.vf  v12 , %0, v0" ::"f"(f1));        
        ...
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+5)*Input_cl+itr*VLMAX+2));
        f0 = Kernel[2];
        asm volatile("vfmacc.vf  v8 , %0, v0" ::"f"(f0));
        f1 = Kernel[9];
        asm volatile("vfmacc.vf  v12 , %0, v0" ::"f"(f1));        
        ...
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+5)*Input_cl+itr*VLMAX+3));
        f0 = Kernel[3];
        asm volatile("vfmacc.vf  v8 , %0, v0" ::"f"(f0));
        f1 = Kernel[10];
        asm volatile("vfmacc.vf  v12 , %0, v0" ::"f"(f1));        
        ...
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+5)*Input_cl+itr*VLMAX+4));
        f0 = Kernel[4];
        asm volatile("vfmacc.vf  v8 , %0, v0" ::"f"(f0));
        f1 = Kernel[11];
        asm volatile("vfmacc.vf  v12 , %0, v0" ::"f"(f1));        
        ...
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+5)*Input_cl+itr*VLMAX+5));
        f0 = Kernel[5];
        asm volatile("vfmacc.vf  v8 , %0, v0" ::"f"(f0));
        f1 = Kernel[12];
        asm volatile("vfmacc.vf  v12 , %0, v0" ::"f"(f1));        
        ...
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+5)*Input_cl+itr*VLMAX+6));
        f0 = Kernel[6];
        asm volatile("vfmacc.vf  v8 , %0, v0" ::"f"(f0));
        f1 = Kernel[13];
        asm volatile("vfmacc.vf  v12 , %0, v0" ::"f"(f1));        
        ...
        #pragma region 6
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+6)*Input_cl+itr*VLMAX));
        f0 = Kernel[0];
        asm volatile("vfmul.vf   v4 , v0, %0" ::"f"(f0));
        f1 = Kernel[7];
        asm volatile("vfmacc.vf  v8 , %0, v0" ::"f"(f1));        
        ...
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+6)*Input_cl+itr*VLMAX+1));
        f0 = Kernel[1];
        asm volatile("vfmacc.vf  v4 , %0, v0" ::"f"(f0));
        f1 = Kernel[8];
        asm volatile("vfmacc.vf  v8 , %0, v0" ::"f"(f1));        
        ...
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+6)*Input_cl+itr*VLMAX+2));
        f0 = Kernel[2];
        asm volatile("vfmacc.vf  v4 , %0, v0" ::"f"(f0));
        f1 = Kernel[9];
        asm volatile("vfmacc.vf  v8 , %0, v0" ::"f"(f1));        
        ...
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+6)*Input_cl+itr*VLMAX+3));
        f0 = Kernel[3];
        asm volatile("vfmacc.vf  v4 , %0, v0" ::"f"(f0));
        f1 = Kernel[10];
        asm volatile("vfmacc.vf  v8 , %0, v0" ::"f"(f1));        
        ...
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+6)*Input_cl+itr*VLMAX+4));
        f0 = Kernel[4];
        asm volatile("vfmacc.vf  v4 , %0, v0" ::"f"(f0));
        f1 = Kernel[11];
        asm volatile("vfmacc.vf  v8 , %0, v0" ::"f"(f1));        
        ...
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+6)*Input_cl+itr*VLMAX+5));
        f0 = Kernel[5];
        asm volatile("vfmacc.vf  v4 , %0, v0" ::"f"(f0));
        f1 = Kernel[12];
        asm volatile("vfmacc.vf  v8 , %0, v0" ::"f"(f1));        
        ...
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+6)*Input_cl+itr*VLMAX+6));
        f6 = Kernel[48];
        asm volatile("vfmacc.vf  v28, %0, v0" ::"f"(f6));
        f0 = Kernel[6];
        asm volatile("vfmacc.vf  v4 , %0, v0" ::"f"(f0));
        ...
        asm volatile("vse32.v v28, (%0)" :: "r"(Out_Img+(row)*COL+itr*(VLMAX)));
        #pragma endregion
        ...
        #pragma region 0
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+0)*Input_cl+itr*VLMAX));
        ...
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+0)*Input_cl+itr*VLMAX+1));
        f0 = Kernel[1];
        asm volatile("vfmacc.vf  v28, %0, v0" ::"f"(f0));
        f1 = Kernel[8];
        asm volatile("vfmacc.vf  v4 , %0, v0" ::"f"(f1));        
        ...
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+0)*Input_cl+itr*VLMAX+2));
        f0 = Kernel[2];
        asm volatile("vfmacc.vf  v28, %0, v0" ::"f"(f0));
        f1 = Kernel[9];
        asm volatile("vfmacc.vf  v4 , %0, v0" ::"f"(f1));        
        ...
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+0)*Input_cl+itr*VLMAX+3));
        f0 = Kernel[3];
        asm volatile("vfmacc.vf  v28, %0, v0" ::"f"(f0));
        f1 = Kernel[10];
        asm volatile("vfmacc.vf  v4 , %0, v0" ::"f"(f1));        
        ...
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+0)*Input_cl+itr*VLMAX+4));
        f0 = Kernel[4];
        asm volatile("vfmacc.vf  v28, %0, v0" ::"f"(f0));
        f1 = Kernel[11];
        asm volatile("vfmacc.vf  v4 , %0, v0" ::"f"(f1));        
        ...
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+0)*Input_cl+itr*VLMAX+5));
        f0 = Kernel[5];
        asm volatile("vfmacc.vf  v28, %0, v0" ::"f"(f0));
        f1 = Kernel[12];
        asm volatile("vfmacc.vf  v4 , %0, v0" ::"f"(f1));        
        ...
        asm volatile("vle32.v v0, (%0)" :: "r"(In_Img+(row+0)*Input_cl+itr*VLMAX+6));
        f6 = Kernel[48];
        asm volatile("vfmacc.vf  v24, %0, v0" ::"f"(f6));
        f0 = Kernel[6];
        asm volatile("vfmacc.vf  v28, %0, v0" ::"f"(f0));
        ...
        asm volatile("vse32.v v24, (%0)" :: "r"(Out_Img+(row-6)*COL+itr*(VLMAX)));
        #pragma endregion
        ...
        asm volatile("vse32.v v20, (%0)" :: "r"(Out_Img+(row-5)*COL+itr*(VLMAX)));
        #pragma endregion
